...
| Feature | Description |
|---------|-------------|
| 🧭 Vue Router | Multi-page navigation (`/`, `/services`, `/contact`, `/manual`) with lazy-loaded route chunks |
...
| 📖 User Manual | Categorized manual page with 10 sections, collapsible sidebar TOC, scroll-spy highlighting, bilingual content |
...
| User Manual | `/manual` | Standalone page — 10 categorized sections (Getting Started / Migration Operations / Config Guide / Reference / Troubleshooting / Best Practices / CLI Reference / Logging & Monitoring / FAQ / Appendix) with collapsible sidebar TOC and scroll-spy |
...
│   │   │   └── useManual.js       # Manual content composable (10 categorized sections, bilingual)
│   │   ├── router/
│   │   │   └── index.js           # Vue Router config (/, /services, /contact, /manual)
│   │   ├── views/
│   │   │   ├── HomePage.vue       # Home page (all main sections)
│   │   │   ├── ServicesPage.vue   # Services standalone page
│   │   │   ├── ContactPage.vue    # Contact standalone page
│   │   │   ├── ManualPage.vue     # User manual standalone page (categorized sidebar + scroll-spy)
...
- `createWebHistory` HTML5 history mode with 4 routes: `/`, `/services`, `/contact`, `/manual`
...
| **ManualPage** | Categorized user manual with 10 sections, collapsible sidebar TOC with scroll-spy highlighting, IntersectionObserver-driven active section tracking, bilingual content via `useManual` composable (standalone on `/manual`) |
