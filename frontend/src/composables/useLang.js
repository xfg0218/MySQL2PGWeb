...
const zh = {
  // Nav
  nav: { pain: '痛点', features: '功能', architecture: '架构', metrics: '性能', flow: '流程', quickstart: '快速开始', quickStartBtn: '快速开始', services: '服务', contact: '联系我们', backHome: '返回首页', manual: '使用手册' },
...
./mysql2pg report \\
    ...
    compareGroups: [
      {
        title: '迁移能力',
        rows: [
          { label: 'DDL 转换（表结构/索引）', open: true, commercial: true },
  ...
  manual: {
    title: 'MySQL2PG 使用手册',
    desc: '从安装到迁移，从配置到排障，覆盖 MySQL2PG 全部使用场景的完整指南。',
    toc: '目录',
    officialSite: '官网',
    wikiLink: 'https://github.com/xfg0218/MySQL2PG/wiki',
    wikiText: '查看完整文档',
  },
  ...
  notFound: {
    title: '页面未找到',
    desc: '您访问的页面不存在或已被移动。请返回首页或查看使用手册。',
    backHome: '返回首页',
    goFaq: '查看使用手册',
  }
}
...
const en = {
  // Nav
  nav: { pain: 'Pain Points', features: 'Features', architecture: 'Architecture', metrics: 'Metrics', flow: 'Workflow', quickstart: 'Quick Start', quickStartBtn: 'Quick Start', services: 'Services', contact: 'Contact', backHome: 'Back to Home', manual: 'Manual' },
...
./mysql2pg report \\
  ...
  manual: {
    tag: 'Manual',
    title: 'MySQL2PG User Manual',
    desc: 'From installation to migration, from configuration to troubleshooting — a complete guide covering all MySQL2PG usage scenarios.',
    toc: 'Contents',
    officialSite: 'Website',
    wikiLink: 'https://github.com/xfg0218/MySQL2PG/wiki',
    wikiText: 'View Full Docs',
  },
  ...
  notFound: {
    ...
    desc: 'The page you are looking for does not exist or has been moved. Please return to the home page or check the manual.',
