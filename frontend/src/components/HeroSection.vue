<template>
  <section class="hero" id="hero">
    ...
    <div class="hero-content">
      <h1 class="hero-title">
        <span class="highlight">MySQL → PostgreSQL</span><br>
        {{ t.hero.titleLine2 }}
      </h1>
      <p class="hero-desc">{{ t.hero.desc }}</p>
      <div class="hero-actions">
        <a href="#quickstart" class="btn-primary btn-lg">{{ t.hero.quickStart }}</a>
        <a href="https://github.com/xfg0218/MySQL2PG" target="_blank" rel="noopener noreferrer" class="btn-ghost btn-lg">
      ...
      <div class="hero-stats">
        <div class="stat-item" v-for="s in t.hero.stats" :key="s.label">
